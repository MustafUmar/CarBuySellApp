        ...
        <div class="col-sm-12 col-md-5 mb-30">
            ...
            <div class="sbs">
                    <ul class="menu">
                            ...
                            <li><a href="upcomingcars.html">Upcoming Cars</a></li>
        ...
        <div class="col-sm-12 col-md-3 mb-30">
            ...
            <div class="contact-details">
                <p>
                    ...
                    Email: <a href="#">sales@selandbuycars.com</a>
                </p>

                <p>
                    Your Company LTD<br>
                    Street nr 100, 4536534, Abuja, NG
                </p>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            <div class="twitterFeed">				
                ...
                <a href="https://twitter.com/Hogash" class="twitter-follow-button" data-show-count="false">Follow @snbcars</a>
                <!-- twitter script -->
                <script>
                        ! function(d, s, id) {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="bottom clearfix">
                ...
                <div class="copyright">
                        <a href="index.html">
                                <img src="${pageContext.request.contextPath}/resources/client/images/kallyas-footerlogo.svg" alt="Kallyas Demo">
                        </a>

                        <p>
                                © 2018 All rights reserved. By <a href="http://themeforest.net/item/kallyas-responsive-multipurpose-template/3583938">Sell and Buy Cras LTD.</a>.
                        </p>
                </div>
                <!--/ copyright -->
            </div>
