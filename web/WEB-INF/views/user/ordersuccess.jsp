...
<t:usertag>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="subheader-titles">
                                        <h2 class="subheader-maintitle">ORDER SUCCESSFUL</h2>
                                        <h4 class="subheader-subtitle">YOUR ORDER HAS BEEN PLACED</h4>
                                </div>
                                <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-12 col-md-6 col-lg-6 -->
                    ...
                    <div class=" col-sm-12 col-md-12 col-lg-12 mb-md-50">
                        ...
                        <div class="kl-title-block clearfix text-left tbk-symbol--line  tbk-icon-pos--after-title">
                                ...
                                <h2 class="tbk__title kl-font-alt fs-xl fw-semibold black">
                                        <a style="color: green;" class="far fa-check-circle"> </a> ORDER COMPLETED SUCCESSFULLY
                                </h2>							
                        </div>
                        ...
                        <div class="text_box">
                                <div class="kl-store">
                                        <div class="kl-store-info">
                                            <a href="${pageContext.request.contextPath}/user/orders">Check order</a>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/clientjs/plugins/jquery-ui-1.10.3.custom.min.js"></script>
	
	<!-- Custom Kallyas JS codes -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/clientjs/kl-scripts.js"></script>

	<!-- Custom user JS codes -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/clientjs/kl-custom.js"></script>
    </jsp:body>
</t:usertag>